...
is to map the DOM
elements on the window into a tree-like structure.
Any user operations and changes will be synchronized 
to this structure. It will respond to nodes on the window
that are bound by a handler, and the node’s redo/undo, 
